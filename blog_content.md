...
![注册](//wx3.sinaimg.cn/large/7fa15162gy1fsqzegnzwxj20h4064aa6.jpg)
![注册成功](//ws1.sinaimg.cn/large/7fa15162gy1fsqzeoso7vj20or02x0sp.jpg)

接下来先测试一下先不登录访问一下我们的tasks，这里理所当然403无权限访问了
![未登录403](//ws3.sinaimg.cn/large/7fa15162gy1fsqzezp5fzj20dl0d2q3d.jpg)

然后终于能登录了，接下来尝试一下登录之后再次访问tasks看看是什么结果
![登录](//ws1.sinaimg.cn/large/7fa15162gy1fsqzf7q1uwj20f406awel.jpg)
发送了登录请求之后查看响应头，能看到我们生成后的token，那就是登录成功了
![登录成功](//wx4.sinaimg.cn/large/7fa15162gy1fsqzfdpjcuj214y0as3z0.jpg)
接下来只需要把该响应头添加到我们的请求头上去，这里需要把`Bearer[空格]`去掉，注意Bearer后的空格也要去掉，因为postman再选了BearerToken之后会自动在token前面再加一个Bearer
![设置请求头](//ws2.sinaimg.cn/large/7fa15162gy1fsqzfrysllj21660aw750.jpg)
再次访问一下tasks，结果理想当然的是成功啦~
![成功请求](//wx3.sinaimg.cn/large/7fa15162gy1fsqzg491b4j20uw08mwes.jpg)
...
可这发现根本就不关`role`什么事啊    ![沉思](//ws4.sinaimg.cn/large/7fa15162gy1fsqzb0b0c7j203o044q2q.jpg)

```
	User user = userRepository.findByUsername("username");
	String role = user.getRole();
```
![这里写图片描述](//ws2.sinaimg.cn/large/7fa15162gy1fsqzb8duumj201b01bq2r.jpg) 这还不简单！这不就完事了嘛！
...
![测试删除tasks](//ws1.sinaimg.cn/large/7fa15162gy1fsqzcued4xj20ee0eqwf0.jpg)
试试看获取该资源会怎么样，获取tasks资源是没有问题的。
![测试获取tasks](//wx3.sinaimg.cn/large/7fa15162gy1fsqzg491b4j20uw08mwes.jpg)

**接下来重头戏来了**
先在数据库里手动将admin的角色改成`ROLE_ADMIN` 修改完之后再登录一下获取新的token，再去尝试一下删除tasks资源
啪啪啪 成功啦~
![删除成功](//ws1.sinaimg.cn/large/7fa15162gy1fsqzgxdf2mj20fc0fqmxe.jpg)
...
```
这是统一处理后的结果
![这里写图片描述](//wx4.sinaimg.cn/large/7fa15162gy1fsqzhbrakxj216v04aglo.jpg)
